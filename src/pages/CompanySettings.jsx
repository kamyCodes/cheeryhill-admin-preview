...
//     // (The service will wrap this in { stats: ... })
//     const statsPayload = {
//       clients: Number(stats.clients),
//       assetsManaged: String(stats.assetsManaged),
//       yearsOfExperience: Number(stats.yearsOfExperience),
...
//     // If response returns the whole company object, use response.stats
//     // If it returns just the stats object, use response
//     if (response) {
...
//     // 4. Refresh everything to ensure sync
//     await fetchInfo(); 

//   } catch (err) {
//     console.error("Stats Update Error:", err);
//     toast.error("Stats sync failed. Check console for details.", { id: toastId });
//   } finally {
//     setIsSaving(false);
//   }
// };
