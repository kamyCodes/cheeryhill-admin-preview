      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-xl shadow-slate-200/50 p-10 max-w-5xl relative overflow-hidden">
        ...
        {activeTab === "general" && (
          <form onSubmit={handleInfoSubmit} className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="pt-6 border-t border-slate-100">
               <button type="submit" disabled={isSaving} className="bg-[#3866A3] text-white px-10 py-4 rounded-2xl font-black text-[11px] uppercase tracking-[0.2em] flex items-center gap-3 hover:bg-[#2d5284] hover:shadow-lg transition-all disabled:opacity-50 cursor-pointer">
                  {isSaving ? <Loader2 className="animate-spin" size={16} /> : <Save size={16} />} Save Platform Identity
               </button>
            </div>
          </form>
        ...
        {activeTab === "philosophy" && (
          <form onSubmit={handleInfoSubmit} className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <button type="submit" disabled={isSaving} className="bg-[#3866A3] text-white px-10 py-4 rounded-2xl font-black text-[11px] uppercase tracking-[0.2em] flex items-center gap-3 hover:bg-[#2d5284] transition-all cursor-pointer">
                <Save size={16} /> Save Mission & Philosophy
            </button>
          </form>
        )}
